...
| Doc | Use |
|-----|-----|
| [workflow_overview.md](workflow_overview.md) | Day-to-day: ingest → Label Studio → export → import timeline to DB |
...
| [court_calibration_supabase.md](court_calibration_supabase.md) | Court homography: LS stills, `court_calibrations` table + SQL |
